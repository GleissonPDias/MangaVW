...
public class AuthorController {
    ...
    @Operation(summary = "Delete an author", description = "Permanently removes an author from the database. Note: Cannot delete an author if they are currently linked to existing mangas to preserve data integrity.")
    @ApiResponses(value = {
