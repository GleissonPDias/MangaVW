...
public class ChapterController {
    ...
    @Operation(summary = "Update a chapter", description = "Updates the chapter number or language. The chapter can also be reassigned to a different manga if a new valid Manga ID is provided.")
    @ApiResponses(value = {
